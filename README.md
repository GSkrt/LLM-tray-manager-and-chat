...
There is still a lot of features to work on but for v1.0 this is ok. Most work was done on chat interface and rendering of content. As such it hase a feature to chat with **multiple installed models at once** (its like asking for a second opipnion).  
